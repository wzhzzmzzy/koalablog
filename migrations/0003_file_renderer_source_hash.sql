...
INSERT INTO `__new_markdown`("id", "source", "path", "title", "renderer", "content", "sourceHash", "tags", "incoming_links", "outgoing_links", "private", "remoteTruth", "revision", "createdAt", "updatedAt", "deletedAt") SELECT "id", "source", "path", "title", 'markdown', coalesce("content", ''), NULL, "tags", "incoming_links", "outgoing_links", "private", "remoteTruth", "revision", "createdAt", "updatedAt", "deletedAt" FROM `markdown`;--> statement-breakpoint
