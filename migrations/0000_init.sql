...
CREATE UNIQUE INDEX `blob_storage_key_unique` ON `blob_storage` (`key`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `markdown_vault_path_unique` ON `markdown` (`vault_path`);--> statement-breakpoint
