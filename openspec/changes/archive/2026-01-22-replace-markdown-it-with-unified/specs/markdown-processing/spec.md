# Spec: Unified Markdown Processing
...
### Requirement: Markdown-it Dependency
The project MUST NOT depend on `markdown-it` or its ecosystem plugins.

#### Scenario: Dependency Check
- **WHEN** checking `package.json`
- **THEN** `markdown-it` is not present
