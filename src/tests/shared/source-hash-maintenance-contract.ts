...
function defineBackfillBatchContract(harness: SourceHashMaintenanceHarness): void {
...
function defineBackfillConcurrencyContract(harness: SourceHashMaintenanceHarness): void {
...
function defineBackfillValidationContract(harness: SourceHashMaintenanceHarness): void {
...
export function defineSourceHashMaintenanceContract(harness: SourceHashMaintenanceHarness): void {
  describe(`Source Hash maintenance ${harness.name}`, () => {
    ...
    defineBackfillBatchContract(harness)
    defineBackfillConcurrencyContract(harness)
    defineBackfillValidationContract(harness)
  })
}
