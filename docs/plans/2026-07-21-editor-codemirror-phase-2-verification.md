...
- Desktop Chrome：23 条 `/dashboard/edit` 场景；
...
| 完整 Playwright | 通过：24/24；Desktop Chrome 23，mobile Chromium 1 |
...
| Bundle/public route | 通过：editor Page chunk 为 608,049 B / 208,070 B gzip；公共动态页无 editor Page 引用 |
| 原生中文 IME | 待人工 |
| 物理触控选择与滚动 | 待人工 |
